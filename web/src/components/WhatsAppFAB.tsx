    ...
    <div className="fixed bottom-6 left-6 z-40 flex items-end gap-3 sm:left-6">
      ...
      <div className="flex flex-col items-start gap-2">
        ...
        <motion.button
          ...
          className="relative flex items-center gap-2 h-14 rounded-full bg-[#25d366] hover:bg-[#1ebd58] px-5 text-white shadow-2xl shadow-emerald-500/40 transition-colors wa-pulse"
        >
